...
export default function HeroLayout1(props) {
  const { landingCard, overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      overrides: {
        "LOREM IPSUM": {},
