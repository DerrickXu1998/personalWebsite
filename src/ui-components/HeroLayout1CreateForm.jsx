...
export default function HeroLayout1CreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setButton(initialValues.Button);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new HeroLayout1(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "HeroLayout1CreateForm")}
      {...rest}
    >
      <TextField
        label="Header"
