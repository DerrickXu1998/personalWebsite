...
export default function LandingCardUpdateForm(props) {
  const {
    id: idProp,
    landingCard,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = landingCardRecord
      ? { ...initialValues, ...landingCardRecord }
      : initialValues;
  ...
  const [landingCardRecord, setLandingCardRecord] = React.useState(landingCard);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(LandingCard, idProp)
        : landingCard;
      setLandingCardRecord(record);
    };
    queryData();
  }, [idProp, landingCard]);
  React.useEffect(resetStateValues, [landingCardRecord]);
  const validations = {
    Header: [],
    Headline: [],
    Content: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            LandingCard.copyOf(landingCardRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "LandingCardUpdateForm")}
      {...rest}
    >
      <TextField
        label="Header"
